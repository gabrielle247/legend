...
///
/// This defines the local SQLite structure. It matches the 'legend' schema
/// in Supabase 1:1 to ensure complete data availability offline.
final schema = Schema([
  // ---------------------------------------------------------------------------
  ...
  Table(
    ...
    [
      ...
      // ✅ FIXED: Missing columns that caused crashes
      Column.text('class_id'),
      Column.text('enrollment_date'),

      // ✅ THE EFFICIENT FIX: Store subjects here as JSON string
